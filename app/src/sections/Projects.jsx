    ...
    <>
                  ...
                  {p.impact?.length > 0 && (
                    <div className="mt-3 flex flex-wrap gap-2">
                      {p.impact.map((item, idx) => (
                        <span
                          key={idx}
                          className="px-3 py-1 rounded-full bg-gray-100 text-gray-700 dark:bg-gray-800 dark:text-gray-300 text-xs shadow-sm"
                        >
                          {item}
                        </span>
                      ))}
      ...
      {!filtered.length && (
        <p className="text-sm text-gray-500 dark:text-gray-400 mt-6">
          No matches. Try different tags or search text.
        </p>
      )}
    </>
  );
